...
TRANSLATIONS = {
    ...
    "pdf_disc_auto":        {"nl": "Automatisch gegenereerd door YASAFlaskified v{version}. YASA AI-slaapstaging (~85% epoch-overeenkomst, Vallat \\& Walker 2021). Respiratoire scoring volgens psgscoring (paper v35), conform AASM Rule 1A/1B.",
                             "fr": "Généré automatiquement par YASAFlaskified v{version}. Staging du sommeil par YASA AI (~85% concordance par époque, Vallat \\& Walker 2021). Scoring respiratoire par psgscoring (paper v35), conforme à l'AASM Rule 1A/1B.",
                             "en": "Automatically generated by YASAFlaskified v{version}. YASA AI sleep staging (~85% epoch agreement, Vallat \\& Walker 2021). Respiratory scoring by psgscoring (paper v35), per AASM Rule 1A/1B."},
...
_DE_PATCH = {
    ...
    "pdf_disc_auto": "Automatisch generiert von YASAFlaskified v{version}. YASA AI-Schlafstaging (~85% Epoch-Übereinstimmung, Vallat \\& Walker 2021). Respiratorisches Scoring durch psgscoring (Paper v35), gemäß AASM Rule 1A/1B.",
...
_V0112_FRONT_FRESH = {
    ...
    "fp_road_2_b":   {"nl": "Paper v37 in pre-submission review bij <em>Physiological Measurement</em> (co-auteurs Vallat, Remy).",
                      "fr": "Article v37 en relecture préalable chez <em>Physiological Measurement</em> (co-auteurs Vallat, Remy).",
                      "en": "Paper v37 in pre-submission review at <em>Physiological Measurement</em> (co-authors Vallat, Remy).",
                      "de": "Paper v37 in der Pre-Submission-Begutachtung bei <em>Physiological Measurement</em> (Co-Autoren Vallat, Remy)."},
