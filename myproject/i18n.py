...
_V0102_PDF = {
    ...
    "split_night_title": {"nl": "Split-night", "fr": "Nuit divisée",
                          "en": "Split-night", "de": "Split-Night"},
    "split_night_off":   {"nl": "Nee — hele nacht als één geheel",
                          "fr": "Non — nuit entière d'un seul tenant",
                          "en": "No — score the night as one",
                          "de": "Nein — Nacht als Ganzes"},
    "split_night_auto":  {"nl": "Automatisch detecteren",
                          "fr": "Détection automatique",
                          "en": "Detect automatically",
                          "de": "Automatisch erkennen"},
    "split_night_manual":{"nl": "Handmatig: start therapie (minuten na opnamestart)",
                          "fr": "Manuel : début du traitement (minutes après le début)",
                          "en": "Manual: therapy start (minutes after recording start)",
                          "de": "Manuell: Therapiebeginn (Minuten nach Aufzeichnungsbeginn)"},
    "split_night_help":  {
        "nl": "Bij een split-night verdunt één AHI over diagnostiek én titratie de diagnose. Kies dit als de patiënt halverwege aan CPAP ging; het rapport toont dan beide delen apart naast de nacht-AHI.",
        "fr": "Lors d'une nuit divisée, un AHI unique couvrant diagnostic et titration dilue le diagnostic. Choisissez ceci si le patient est passé sous PPC en cours de nuit ; le rapport présentera les deux parties séparément.",
        "en": "In a split-night study a single AHI covering diagnosis and titration dilutes the diagnosis. Choose this if the patient went on CPAP part-way through; the report then shows both parts separately alongside the whole-night AHI.",
    ...
    "pdf_split_hdr": {"nl": "Split-night — de nacht in twee delen",
                      "fr": "Nuit divisée — la nuit en deux parties",
                      "en": "Split-night — the night in two parts",
                      "de": "Split-Night — die Nacht in zwei Teilen"},
    "pdf_split_diagnostic": {"nl": "Diagnostisch deel (vóór therapie)",
                             "fr": "Partie diagnostique (avant traitement)",
                             "en": "Diagnostic part (before therapy)",
                             "de": "Diagnostischer Teil (vor Therapie)"},
    "pdf_split_therapeutic": {"nl": "Onder therapie", "fr": "Sous traitement",
                              "en": "Under therapy", "de": "Unter Therapie"},
    ...
    "pdf_split_col_ahi_unc": {"nl": "AHI incl. ongetypeerd",
                              ...
                              "en": "AHI incl. untyped",
                              "de": "AHI inkl. untypisiert"},
    "pdf_split_note": {
        "nl": "De nacht-AHI hierboven telt beide delen samen en verdunt daardoor de diagnose. Bij een split-night is het diagnostische deel de klinisch relevante meting; het deel onder therapie toont of de behandeling werkt.",
        "fr": "L'IAH de la nuit ci-dessus additionne les deux parties et dilue donc le diagnostic. Lors d'une nuit divisée, la partie diagnostique est la mesure cliniquement pertinente ; la partie sous traitement montre si celui-ci est efficace.",
        "en": "The whole-night AHI above combines both parts and therefore dilutes the diagnosis. In a split-night study the diagnostic part is the clinically relevant measurement; the part under therapy shows whether the treatment works.",
        "de": "Der oben genannte Gesamt-AHI fasst beide Teile zusammen und verwässert damit die Diagnose. Bei einer Split-Night ist der diagnostische Teil die klinisch relevante Messung; der Therapieteil zeigt, ob die Behandlung wirkt.",
    },
    "pdf_split_short": {
        "nl": "⚠ Te weinig slaap in dit deel voor een betrouwbare index.",
        "fr": "⚠ Trop peu de sommeil dans cette partie pour un indice fiable.",
        "en": "⚠ Too little sleep in this part for a reliable index.",
        "de": "⚠ Zu wenig Schlaf in diesem Teil für einen verlässlichen Index.",
    },
    "pdf_split_untyped": {
        "nl": "⚠ {pct}% van de events in dit deel kon niet getypeerd worden (effort-signaal); lees de kolom 'incl. ongetypeerd'.",
        "fr": "⚠ {pct}% des événements de cette partie n'ont pas pu être typés (signal d'effort) ; lisez la colonne « incl. non typés ».",
        "en": "⚠ {pct}% of events in this part could not be typed (effort signal); read the 'incl. untyped' column.",
        "de": "⚠ {pct}% der Ereignisse in diesem Teil konnten nicht typisiert werden (Effort-Signal); lesen Sie die Spalte „inkl. untypisiert“.",
    },
    "prov_split_night":  {"nl": "Split-night — start therapie",
                          "fr": "Nuit divisée — début du traitement",
                          "en": "Split-night — therapy start",
                          "de": "Split-Night — Therapiebeginn"},
    "pdf_split_diag":    {"nl": "AHI diagnostisch deel", "fr": "AHI partie diagnostique",
                          "en": "AHI diagnostic part", "de": "AHI diagnostischer Teil"},
    "pdf_split_ther":    {"nl": "AHI onder therapie", "fr": "AHI sous traitement",
                          "en": "AHI under therapy", "de": "AHI unter Therapie"},
    "pdf_pos_uncoded": {
        "nl": "⚠ De houdingscodering van deze recorder is niet herkend; de labelvolgorde is een aanname. Lees deze rijen niet als een meting, en het POSA-fenotype is niet bepaalbaar.",
        "fr": "⚠ Le codage de position de cet enregistreur n'est pas reconnu ; l'ordre des étiquettes est une hypothèse. Ne lisez pas ces lignes comme une mesure ; le phénotype POSA n'est pas déterminable.",
        "en": "⚠ This recorder's position coding was not recognised; the label order is an assumption. Do not read these rows as a measurement, and the POSA phenotype cannot be determined.",
        "de": "⚠ Die Positionskodierung dieses Rekorders wurde nicht erkannt; die Reihenfolge der Labels ist eine Annahme. Lesen Sie diese Zeilen nicht als Messung; der POSA-Phänotyp ist nicht bestimmbar.",
    },
    "pdf_warn_topography": {
        "nl": "⚠ EEG-topografie atypisch: trage golven occipitaal in plaats van frontaal dominant, en spindels frontaal in plaats van frontocentraal maximaal. Controleer de kanaallabels en de montage van de recorder — de slaapstadiëring draaide op een van deze kanalen.",
        "fr": "⚠ Topographie EEG atypique : ondes lentes occipitales au lieu de frontales dominantes, et fuseaux frontaux au lieu de frontocentraux. Vérifiez les étiquettes des voies et le montage — la stadification s'est appuyée sur l'une de ces voies.",
        "en": "⚠ Atypical EEG topography: slow waves occipital rather than frontally dominant, and spindles frontal rather than frontocentrally maximal. Check the recorder's channel labels and montage — sleep staging ran on one of these channels.",
        "de": "⚠ Atypische EEG-Topographie: langsame Wellen okzipital statt frontal dominant, Spindeln frontal statt frontozentral maximal. Prüfen Sie Kanalbezeichnungen und Montage — die Schlafstadien wurden auf einem dieser Kanäle bestimmt.",
    },
