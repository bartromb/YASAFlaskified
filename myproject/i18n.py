"""
i18n.py — YASAFlaskified v0.8.30
...
TRANSLATIONS = {
    ...
    "pdf_disc_auto":        {"nl": "Automatisch gegenereerd door YASAFlaskified v0.8.30. AI-slaapstaging (LGBM, ~85% epoch-overeenkomst). Signaalverwerking conform AASM Scoring Manual 2.6 (Rule 1A + 1B).",
                             "fr": "Généré automatiquement par YASAFlaskified v0.8.30. Staging du sommeil par IA (LGBM, ~85% concordance par époque). Traitement du signal conforme au Manuel de Scoring AASM 2.6 (Rule 1A + 1B).",
                             "en": "Automatically generated by YASAFlaskified v0.8.30. AI sleep staging (LGBM, ~85% epoch agreement). Signal processing per AASM Scoring Manual 2.6 (Rule 1A + 1B)."},
...
# v0.8.30: Additional multilingual keys for PDF report
_PDF_KEYS = {
...
# ======================================================================
# v0.8.30: German (DE) translations — auto-generated from EN
# ======================================================================
...
_DE_PATCH = {
    ...
    "pdf_disc_auto": "Automatically generated by YASAFlaskified v0.8.30. AI Schlaf staging (LGBM, ~85% epoch agreement). Signal processing per AASM Scoring Manual 2.6 (Rule 1A + 1B).",
...
# v0.8.30: Complete PDF report multilingual keys
_PDF_V027 = {
    "pdf_artifact_count": {
...
# v0.8.30: Final remaining PDF keys
_PDF_V027b = {
    "pdf_artifact_of": {
        "nl": "van",
        "fr": "de",
