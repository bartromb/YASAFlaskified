"""
i18n.py — YASAFlaskified v0.8.23
...
TRANSLATIONS = {
    ...
    "pdf_disc_auto":        {"nl": "Automatisch gegenereerd door YASAFlaskified v0.8.23. AI-slaapstaging (LGBM, ~85% epoch-overeenkomst). Signaalverwerking conform AASM Scoring Manual 2.6 (Rule 1A + 1B).",
                             "fr": "Généré automatiquement par YASAFlaskified v0.8.23. Staging du sommeil par IA (LGBM, ~85% concordance par époque). Traitement du signal conforme au Manuel de Scoring AASM 2.6 (Rule 1A + 1B).",
                             "en": "Automatically generated by YASAFlaskified v0.8.23. AI sleep staging (LGBM, ~85% epoch agreement). Signal processing per AASM Scoring Manual 2.6 (Rule 1A + 1B)."},
