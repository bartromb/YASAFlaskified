# YASAFlaskified v0.8.37 — Installatiegids
...
4. [Update naar v0.8.37](#4-update-van-update-naar-v0835)
...
10. [Wat er veranderd is in v0.8.37](#10-wat-er-veranderd-is-in-v0835)
...
`requirements.txt`, `psgscoring==0.4.3`). Geen handmatige stappen
...
Verwachte output: `psgscoring 0.4.3 OK` (of nieuwer; zie `requirements.txt` voor de actieve pin).
...
Verwachte output: `psgscoring 0.4.3`. Zo niet:
...
## 10. Wat er veranderd is in v0.8.37
...
**psgscoring** wordt geïnstalleerd vanaf PyPI (`pip install psgscoring==0.4.3`,
...
*YASAFlaskified v0.8.37 — Bart Rombaut MD, Slaapkliniek AZORG, Aalst*
